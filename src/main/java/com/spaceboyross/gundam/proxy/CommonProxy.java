...
import com.spaceboyross.gundam.ms.gundams.ASWG08GundamBarbatosLupusMobileSuit;
import com.spaceboyross.gundam.ms.gundams.ASWG08GundamBarbatosLupusRexMobileSuit;
import com.spaceboyross.gundam.ms.gundams.ASWG08GundamBarbatosMobileSuit;
import com.spaceboyross.gundam.ms.gundams.GATX102DuelGundamMobileSuit;
import com.spaceboyross.gundam.ms.gundams.GN001GundamExiaMobileSuit;
import com.spaceboyross.gundam.ms.gundams.GX9901DXGundamDoubleXMobileSuit;
import com.spaceboyross.gundam.ms.gundams.MSZ006ZetaGundamMobileSuit;
import com.spaceboyross.gundam.ms.gundams.RX178GundamMkIIMobileSuit;
...
import com.spaceboyross.gundam.ms.gundams.ZGMFX09AJusticeGundamMobileSuit;
import com.spaceboyross.gundam.ms.gundams.ZGMFX10AFreedomGundamMobileSuit;
import com.spaceboyross.gundam.ms.gundams.ZGMFX20AStrikeFreedomGundamMobileSuit;
...
public class CommonProxy {
	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		MSRegistry.register(new RX178GundamMkIIMobileSuit());
		...
		MSRegistry.register(new GX9901DXGundamDoubleXMobileSuit());
		MSRegistry.register(new AGE1GundamAGE1NormalMobileSuit());
		MSRegistry.register(new GATX102DuelGundamMobileSuit());
		MSRegistry.register(new ZGMFX09AJusticeGundamMobileSuit());
		MSRegistry.register(new ZGMFX10AFreedomGundamMobileSuit());
		MSRegistry.register(new ZGMFX20AStrikeFreedomGundamMobileSuit());
		MSRegistry.register(new GN001GundamExiaMobileSuit());
		MSRegistry.register(new ASWG08GundamBarbatosMobileSuit());
		MSRegistry.register(new ASWG08GundamBarbatosLupusMobileSuit());
		MSRegistry.register(new ASWG08GundamBarbatosLupusRexMobileSuit());
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		event.getRegistry().register(new TransPhaseArmorItem());
