...
public class MoonTerrainGenerator extends NormalTerrainGenerator {
                    ...
                    for(int h = 0;h < 8;h++) {
                        ...
                        for(int x = 0;x < 4;x++) {
                            ...
                            for(int z = 0;z < 4;z++) {
                                ...
                                else if((d15 += d16) > 0.0D) primer.setBlockState(x4*4+x,height32*8+h,z4*4+z,GundamBlocks.moonRock.getDefaultState());
                            }
                            d10 += d12;
                            d11 += d13;
                        }
